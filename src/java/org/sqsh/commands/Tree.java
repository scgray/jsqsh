...
public class Tree extends Command implements DatabaseCommand,
    ...
    private static class Options extends SqshOptions {
        ...
        @OptionProperty(option = 't', longOption = "table-pattern", arg = REQUIRED, argName = "pattern", description = "Provides a pattern to match against table names")
        public String tablePattern = "%";

        @OptionProperty(option = 's', longOption = "schema-pattern", arg = REQUIRED, argName = "pattern", description = "Provides a pattern to match against schema names")
