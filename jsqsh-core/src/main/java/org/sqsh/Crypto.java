...
/**
 * Provides basic encryption/description using the java security encryption framework.
 */
public class Crypto {

    public static byte[] DEFAULT_KEY =
            {(byte) 0xd1, (byte) 0x09, (byte) 0x79, (byte) 0x1, (byte) 0x96, (byte) 0xdf, (byte) 0x6a, (byte) 0x69,
                    (byte) 0xf3, (byte) 0x08, (byte) 0x52, (byte) 0xac, (byte) 0xb2, (byte) 0xb0, (byte) 0x4a,
                    (byte) 0x91};
     ...
     *
     * @param key The key to use for encryption. The encryption algorithm used is Blowfish so the key should
     *         conform to what Blowfish expects.
