...
/**
 * Container for a block of settings that are used for connecting to a specific database platform. This object is also a
 * self-describing {@link SqshOptions} and as such can be populated using the {@link org.sqsh.options.OptionProcessor}.
 */
public class ConnectionDescriptor extends SqshOptions implements Cloneable, Comparable<ConnectionDescriptor> {

    @OptionProperty(option = 'S', longOption = "server", arg = REQUIRED, argName = "server",
            description = "Name of the database server to connect to")
    public String server = null;

    @OptionProperty(option = 'p', longOption = "port", arg = REQUIRED, argName = "port",
            description = "Listen port for the server to connect to")
    public int port = -1;

    @OptionProperty(option = 'D', longOption = "database", arg = REQUIRED, argName = "db",
            description = "Database (catalog) context to use upon connection")
    public String database = null;

    @OptionProperty(option = 'U', longOption = "user", arg = REQUIRED, argName = "user",
            description = "Username utilized for connection")
    public String username = null;

    @OptionProperty(option = 'P', longOption = "password", arg = REQUIRED, argName = "pass",
            description = "Password utilized for connection")
    public String password = null;

    @OptionProperty(option = 'w', longOption = "domain", arg = REQUIRED, argName = "domain",
            description = "Windows domain to be used for authentication")
    public String domain = null;

    @OptionProperty(option = 'O', longOption = "prop", arg = REQUIRED, argName = "name=val",
    ...
    @OptionProperty(option = 'V', longOption = "url-var", arg = REQUIRED, argName = "name=val",
            description = "Set a driver URL variable. Can be used more than once")
    public List<String> urlVariables = new ArrayList<String>();

    @OptionProperty(option = 'c', longOption = "jdbc-class", arg = REQUIRED, argName = "driver",
            description = "JDBC driver class to utilize")
    public String driverClass = null;

    @OptionProperty(option = 'd', longOption = "driver", arg = REQUIRED, argName = "driver",
            description = "Name of jsqsh driver to be used for connection")
    public String driverName = null;

    @OptionProperty(option = 'u', longOption = "jdbc-url", arg = REQUIRED, argName = "url",
            description = "JDBC url to use for connection")
    public String url = null;

    @OptionProperty(option = 'A', longOption = "autoconnect", arg = NONE, argName = "bool",
    ...
    /**
     * @return True if this connection is set to be used by jsqsh to automatically connect with upon startup.
     */
    ...
    /**
     * Sets whether or not this connection will automatically be used to establish a connection when jsqsh starts.
     * Enabling autoconnect for one connection, turns it off for any other connection definition that had it set.
     *
     ...
     * @param isEncrypted If true, the password that is supplied is encrypted via a call to
    ...
    /**
     * @return The set of variables that are to be used when expanding variables in the URL of JDBC driver during
     *         connect.
     */
    ...
    /**
     * Given a two lists of "name=value" pairs, adds the values in the existing list from the toBeAdded list, replacing
     * an existing variable by the same name along the way.
     *
