...
public class Parse extends Command {
    ...
    private static class ParserListener implements SQLParserListener {
        ...
        /**
         * @see org.sqsh.parser.SQLParserListener#foundTableReference(org.sqsh.parser.SQLParser,
         *         org.sqsh.parser.DatabaseObject)
         */
