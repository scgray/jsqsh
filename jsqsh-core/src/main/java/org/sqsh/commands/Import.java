...
public class Import extends Command {
    ...
    private static class Options extends SqshOptions {
        @Argv(program = "\\import", min = 0, max = 1, usage = "package")
    ...
    public int execute(Session session, SqshOptions opts) throws Exception {
        ...
        try {
            ...
            session.err.println("Failed to load extension \"" + packageName + "\": " + e.getMessage());
    ...
    private void doDisplayImports(Session session) {
        ...
        columns[0] = new ColumnDescription("Name", -1, Alignment.LEFT, OverflowBehavior.WRAP, false);
        columns[1] = new ColumnDescription("Directory", -1, Alignment.LEFT, OverflowBehavior.WRAP, false);
        columns[2] = new ColumnDescription("Loaded", -1, Alignment.LEFT, OverflowBehavior.WRAP, false);
        columns[3] = new ColumnDescription("Disabled", -1, Alignment.LEFT, OverflowBehavior.WRAP, false);
