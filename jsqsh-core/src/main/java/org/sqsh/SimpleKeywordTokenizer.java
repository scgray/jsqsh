...
public class SimpleKeywordTokenizer {
    ...
    /**
     * Skips sequences of characters that we just don't care about. In reality we only care about key words  and the
     * semicolon character, but we also need to watch for comments.
     */
    private void doSkip() {
        boolean done = false;
        while (!done && idx < len) {
