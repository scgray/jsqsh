...
public class DatabaseObject {
    ...
    /**
     * @return the catalog containing the object that is referenced. or null if the object is unknown.
     */
    ...
    /**
     * @return the schema of the object that is referenced. or null if the schema is unknown.
     */
    ...
    public String toString() {
        ...
        if (catalog != null) {
            sb.append('[').append(catalog).append(']').append('.');
        }
        if (schema != null) {
    ...
    public boolean equals(Object o) {
        if (o instanceof DatabaseObject) {
            ...
            boolean matches = (that.catalog == null && this.catalog == null)
                    || (that.catalog != null && this.catalog != null && that.catalog.equals(this.catalog));
            matches = matches && (that.schema == null && this.schema == null)
                    || (that.schema != null && this.schema != null && that.schema.equals(this.schema));
            matches = matches && (that.name == null && this.name == null)
                    || (that.name != null && this.name != null && that.name.equals(this.name));
            matches = matches && (that.column == null && this.column == null)
                    || (that.column != null && this.column != null && that.column.equals(this.column));
            matches = matches && (that.alias == null && this.alias == null)
                    || (that.alias != null && this.alias != null && that.alias.equals(this.alias));
            return matches;
        }
        return false;
    }
