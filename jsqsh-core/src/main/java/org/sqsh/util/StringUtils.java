...
public class StringUtils {
    ...
    public enum BadEscapeHandling {
        ...
        /**
         * In an un-recognized escape sequence, such as <code>\q</code> drop the escape
         * character (leaving just the <code>q</code>)
         */
    ...
    /**
     * Given a string, process any escapes within it according to java based rules. This handles
     * the following cases:
     * <ul>
    ...
    private static int getCharEscapeValue(final String escType, final String str, final int strLen, int idx, final int nDigits) {
        ...
        for (int i = idx; i < (idx + nDigits); i++) {
            ...
            if (ch >= '0' && ch <= '9') {
                ...
                throw new IllegalArgumentException("Invalid value in character escape "
                        + escType + str.substring(idx, idx+nDigits));
            }
        }
