...
/**
 * An alternative to Java's {@link SimpleDateFormat} object that modifies the meaning of the "S" field to indicate
 * number of digits of the fractional portion of the time instead of strictly milliseconds.
 */
public class TimestampFormatter {
    ...
    public TimestampFormatter(String format) {
        ...
        // Search through the format for a span of "S" characters that are not contained within quotes...
        while (idx < len) {
    ...
    public String format(Date date) {
        ...
        if (nFractionalDigits > 0) {
            ...
            int nanos = (date instanceof Timestamp) ? ((Timestamp) date).getNanos()
