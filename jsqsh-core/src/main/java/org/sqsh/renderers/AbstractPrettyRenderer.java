...
public abstract class AbstractPrettyRenderer extends Renderer {

    /**
     * To save a bajillion object creations we create a set of line iterators that we will re-use throughout the
     * rendering process.
     */
    private LineIterator[] iterators = null;
    protected boolean hasOuterBorder;

    public AbstractPrettyRenderer(Session session, RendererManager renderMan, boolean hasOuterBorder) {
    ...
    public void header(ColumnDescription[] columns) {
        ...
        // Throw away our column iterators since we have a new result set comine.
        iterators = null;
    }
